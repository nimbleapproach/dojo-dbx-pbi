...
# MAGIC %md
# MAGIC ##Process: data_quality_check_14

# COMMAND ----------

# MAGIC %md
# MAGIC ## Tests for bi_data_model.loyalty_acct_archive
# MAGIC
# MAGIC The purpose of this test is to check for a loss of historic data in bi_data_model.loyalty_acct_archive.
# MAGIC
...
historical_aggregation_query = """
                     ...
                     {catalog}.{schema}.loyalty_acct_archive""".format(catalog=catalog, schema=schema)

# COMMAND ----------
try:
    error_message = None
    status = spark.sql(historical_aggregation_query).collect()[0][0] >= 2339190
