...
# MAGIC %md
# MAGIC ##Process: data_quality_check_18

# COMMAND ----------

# MAGIC %md
# MAGIC ## Test for activity_time_series
# MAGIC
# MAGIC The purpose of this test is to detect a loss of data for the current day in bi_data_model.activity_time_series.
# MAGIC
# MAGIC This table is appended to daily by a databricks workflow.
# MAGIC
# MAGIC It uses the the median value to test for a value in active_prev_d for today. If todays value is less than 50% of the median of the values for the previous 20 days, then today's  value is classed as an outlier.
# MAGIC
...
daily_query = f"""
                ...
                active_prev_d as active_prev_d
                FROM {catalog}.{schema}.activity_time_series
