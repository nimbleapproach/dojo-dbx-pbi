...
# MAGIC %md
# MAGIC ##Process: data_quality_check_20

# COMMAND ----------

# MAGIC %md
# MAGIC ## Test for nursery_time_series
# MAGIC
# MAGIC The purpose of this test is to detect a loss of data for the current day in bi_data_model.nursery_time_series.
# MAGIC
# MAGIC This table is appended to daily by a databricks workflow.
# MAGIC
# MAGIC It uses the the median value to test for a value in 'nursery' for today. If todays value is less than 80% of the median of the values for the previous 8 days, then today's value is classed as an outlier.
# MAGIC
...
prev_day = 8 #number of previous days we check

daily_tolerance = 0.80
...
daily_query = f"""
            ...
            nursery as nursery
            FROM {catalog}.{schema}.nursery_time_series
