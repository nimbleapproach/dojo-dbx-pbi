...
# MAGIC %md
# MAGIC ##Process: data_quality_check_26

# COMMAND ----------

# MAGIC %md
# MAGIC ## Test for job: foundations_v1_job_google_api
# MAGIC
# MAGIC This notebook checks whether the job foundations_v1_job_google_api has been run today.
...
job_name = "foundations_v1_job_google_api"
...
(spark.sql(f"""
          SELECT
          {check_id} as check_id,'{definition}' as definition, {False} as status, "Notebook did not complete execution." as error_message, '{url}' as run_url
