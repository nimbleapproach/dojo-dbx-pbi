...
# MAGIC %md
# MAGIC ##Process: data_quality_check_3
...
# MAGIC
# MAGIC The purpose of this test is to detect a loss of data for the current day, a loss of historic data or duplicate data in wallet_pos_txns.
# MAGIC
