...
# MAGIC %md
# MAGIC ## Test for job: foundations_v1_job_crm_send_level_engine
# MAGIC
# MAGIC This notebook checks whether the job foundations_v1_job_crm_send_level_engine has been run today.
...
job_name = "foundations_v1_job_crm_send_level_engine"
