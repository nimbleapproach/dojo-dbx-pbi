...
# MAGIC %md
# MAGIC ##Process: data_quality_check_41

# COMMAND ----------

# MAGIC %md
# MAGIC ## Tests for cdd_odl_cmpgn_products
# MAGIC
...
error_message = None
daily_query = f"""SELECT CAST(cdd_upd_ts as date) as load_dt, COUNT(*) 
                FROM {core_catalog}.gb_customer_data_domain_odl.cdd_odl_cmpgn_products 
                GROUP BY CAST(cdd_upd_ts as date) 
                ORDER BY CAST(cdd_upd_ts as date) desc"""
