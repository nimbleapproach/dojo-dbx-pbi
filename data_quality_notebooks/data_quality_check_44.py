...
# MAGIC %md
# MAGIC ##Process: data_quality_check_44

# COMMAND ----------

# MAGIC %md
# MAGIC ## Test datamart table ar_cust_rewards_visits
# MAGIC
# MAGIC This notebook checks whether the the table ar_cust_rewards_visits has data for the current day -2
# MAGIC
...
date_column_query = f"""
                    SELECT CAST(visit_dt AS date) AS dt FROM {catalog}.cdna_ar.ar_cust_rewards_visits
