...
# MAGIC %md
# MAGIC ## Test datamart table ar_cust_full_visit_history
# MAGIC
# MAGIC This notebook checks whether the the table ar_cust_full_visit_history has data for the current day -2
# MAGIC
