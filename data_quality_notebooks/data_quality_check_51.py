...
# MAGIC %md
# MAGIC ##Process: data_quality_check_51
...
# MAGIC
# MAGIC This notebook checks whether the the table ar_cust_earning has any data
...
query = f"""
                    SELECT * FROM {catalog}.cdna_ar.ar_cust_earning
                    LIMIT 5
"""
