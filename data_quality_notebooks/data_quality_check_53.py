...
# MAGIC %md
# MAGIC ##Process: data_quality_check_53

# COMMAND ----------

# MAGIC %md
# MAGIC ## Test datamart table cdna_ar.ar_cmpgn_setup
# MAGIC
# MAGIC This notebook checks whether the the table cdna_ar.ar_cmpgn_setup has data for the previous friday or more recently
# MAGIC
...
date_column_query = f"""
                    SELECT CAST(event_ts AS date) AS dt FROM {catalog}.cdna_ar.ar_cmpgn_setup
