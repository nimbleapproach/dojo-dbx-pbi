...
# MAGIC %md
# MAGIC ##Process: data_quality_check_54

# COMMAND ----------

# MAGIC %md
# MAGIC ## Test datamart table dsa_ar_customer_wk_smry
# MAGIC
# MAGIC This notebook checks whether the most recent data in table dsa_ar_customer_wk_smry is from last complete week
...
table_query = f"""
                SELECT week as week_nbr FROM {catalog}.cdna_ar.dsa_ar_customer_wk_smry
                    GROUP BY week
                    ORDER BY week DESC
                    limit 20
"""
