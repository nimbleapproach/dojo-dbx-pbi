...
# MAGIC %md
# MAGIC ##Process: data_quality_check_56

# COMMAND ----------

# MAGIC %md
# MAGIC ## Test datamart table dsa_pbi_ar_gsm_store_agg
# MAGIC
# MAGIC This notebook checks whether the most recent data in table dsa_pbi_ar_gsm_store_agg is from last complete week
...
table_query = f"""
                SELECT week as week_nbr FROM {catalog}.cdna_ar.dsa_pbi_ar_gsm_store_agg
                    GROUP BY week
                    ORDER BY week DESC
                    limit 20
"""
