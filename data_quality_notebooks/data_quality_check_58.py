...
# MAGIC %md
# MAGIC ##Process: data_quality_check_58

# COMMAND ----------

# MAGIC %md
# MAGIC ## Test datamart table ar_store_visits_ar_flag
# MAGIC
# MAGIC This notebook checks whether the the table ar_store_visits_ar_flag has data for the current day -1 Or current_day - 2
# MAGIC
...
date_column_query = f"""
                    SELECT CAST(visit_dt AS date) AS dt FROM {catalog}.cdna_ar.ar_store_visits_ar_flag
