...
# MAGIC %md
# MAGIC ##Process: data_quality_check_59

# COMMAND ----------

# MAGIC %md
# MAGIC ## Test datamart table dsa_pbi_ar_sdb_tracker_inc_ghs
# MAGIC
# MAGIC This notebook checks whether the the table dsa_pbi_ar_sdb_tracker_inc_ghs has data for the current day -1 or current day -2
# MAGIC
...
date_column_query = f"""
                    SELECT CAST(visit_date AS date) AS dt FROM {catalog}.cdna_ar.dsa_pbi_ar_sdb_tracker_inc_ghs
