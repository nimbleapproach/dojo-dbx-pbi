...
# MAGIC %md
# MAGIC ##Process: data_quality_check_61

# COMMAND ----------

# MAGIC %md
# MAGIC ## Test datamart table dsa_pbi_ar_store_sales_output
# MAGIC
# MAGIC This notebook checks whether the the table dsa_pbi_ar_store_sales_output has data for the current day -1
# MAGIC
...
date_column_query = f"""
                    SELECT CAST(visit_date AS date) AS dt FROM {catalog}.cdna_ar.dsa_pbi_ar_store_sales_output
...
try:
   status = date_column_check(date_column_query, prev_day, spark)
