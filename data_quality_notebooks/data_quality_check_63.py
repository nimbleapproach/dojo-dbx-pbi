...
# MAGIC %md
# MAGIC ##Process: data_quality_check_63

# COMMAND ----------

# MAGIC %md
# MAGIC ## Test for job: cdna_ar_daily_store
# MAGIC
# MAGIC This notebook checks whether the job cdna_ar has been run today.
