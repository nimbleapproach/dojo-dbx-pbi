...
# MAGIC CREATE WIDGET TEXT table_name DEFAULT "active_earners";
...
# MAGIC      full_date DATE COMMENT "Please add comments.",
# MAGIC      earning_7d INT COMMENT "Please add comments.",
# MAGIC      active_7d INT COMMENT "Please add comments.", 
# MAGIC      percentage DOUBLE COMMENT "Please add comments." 
# MAGIC     
# MAGIC      ) 
