...
# MAGIC CREATE WIDGET TEXT table_name DEFAULT "app_usage_api";
...
# MAGIC       date STRING, 
# MAGIC       first_opens STRING, 
# MAGIC       activeUsers STRING, 
# MAGIC       active7DayUsers STRING, 
# MAGIC       active28DayUsers STRING, 
# MAGIC       sessions STRING, 
# MAGIC       engagedSessions STRING, 
# MAGIC       averageSessionDuration STRING, 
# MAGIC       userEngagementDuration STRING, 
# MAGIC       engagementRate STRING, 
# MAGIC       app_removes STRING
# MAGIC     ) 
