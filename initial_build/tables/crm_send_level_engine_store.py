...
# MAGIC CREATE WIDGET TEXT table_name DEFAULT "crm_send_level_engine_store";
...
# MAGIC     store_orderers BIGINT,
# MAGIC     store_orders BIGINT,
# MAGIC     store_items BIGINT,
# MAGIC     store_sales DECIMAL(16,2),
# MAGIC     store_orderers_mailed DOUBLE,
# MAGIC     store_avg_order DECIMAL(37,23),
# MAGIC     store_orders_orderers DOUBLE,
# MAGIC     store_sales_mailed DECIMAL(37,23),
# MAGIC     store_items_order DOUBLE
# MAGIC ) 
# MAGIC
