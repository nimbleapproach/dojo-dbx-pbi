...
# MAGIC CREATE WIDGET TEXT table_name DEFAULT "crm_send_level_rewards_george";
...
# MAGIC     george_sales DECIMAL(16,2),
# MAGIC     george_orderers_mailed DOUBLE,
# MAGIC     george_avg_order DECIMAL(37,23),
# MAGIC     george_orders_orderers DOUBLE,
# MAGIC     george_sales_mailed DECIMAL(37,23),
