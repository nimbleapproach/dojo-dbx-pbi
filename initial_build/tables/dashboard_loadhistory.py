...
# MAGIC CREATE WIDGET TEXT table_name DEFAULT "dashboard_loadhistory";
# MAGIC
...
# MAGIC      Table_Name STRING COMMENT "Please add comments.", 
# MAGIC      UC_Load_Date DATE COMMENT "Please add comments.",  
# MAGIC      UC_Load_Date_Time TIMESTAMP COMMENT "Please add comments.",  
# MAGIC      Time_stamp INT COMMENT "Please add comments." 
# MAGIC      ) 
