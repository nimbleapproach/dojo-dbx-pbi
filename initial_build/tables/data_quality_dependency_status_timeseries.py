...
# MAGIC CREATE WIDGET TEXT table_name DEFAULT "data_quality_dependency_status_timeseries";
...
# MAGIC      pass_rate_last_7_days FLOAT NOT NULL COMMENT "The pass rate of the dependency, at this hour, over the past week.",
# MAGIC      pass_rate_last_30_days FLOAT NOT NULL COMMENT "The pass rate of the dependency, at this hour, over the past month.",
# MAGIC      CONSTRAINT pk_${widget.table_name} PRIMARY KEY(dependency_id,hour_of_day)
# MAGIC      ) 
# MAGIC      COMMENT "Table contains information on how the readiness rate of dependencies changes throughout the day."
# MAGIC      TBLPROPERTIES ( 
