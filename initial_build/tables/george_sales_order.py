...
# MAGIC CREATE WIDGET TEXT table_name DEFAULT "george_sales_order";
# MAGIC
...
# MAGIC      Order_date STRING COMMENT "Please add comments.", 
# MAGIC      GEORGE_Customer BIGINT COMMENT "Please add comments.",  
# MAGIC      George_Sales DECIMAL(19,2) COMMENT "Please add comments."
# MAGIC      ) 
