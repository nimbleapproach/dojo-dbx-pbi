...
# MAGIC CREATE WIDGET TEXT table_name DEFAULT "monitoring_table_row_count";
...
# MAGIC      table_catalog STRING COMMENT "", 
# MAGIC      table_schema STRING COMMENT "",  
# MAGIC      table_name STRING COMMENT "",
# MAGIC      row_count LONG COMMENT "",
# MAGIC      dts TIMESTAMP COMMENT "Time when record was captured",  
# MAGIC      error_message STRING COMMENT "error message if query to get row count has failed." 
# MAGIC      ) 
# MAGIC      COMMENT "monitoring table to capture row counts"
# MAGIC      TBLPROPERTIES ( 
