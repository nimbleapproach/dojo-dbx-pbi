...
# MAGIC CREATE WIDGET TEXT table_name DEFAULT "screen_views";
...
# MAGIC       full_date STRING, 
# MAGIC       unifiedScreenName STRING, 
# MAGIC       screenPageViews STRING,
# MAGIC       screenPageViewsPerSession STRING
# MAGIC     ) 
