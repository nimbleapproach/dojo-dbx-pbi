...
# MAGIC CREATE WIDGET TEXT view_name DEFAULT "vw_cashpot_ajds";
...
# MAGIC     , cast(trans_ts as date) as trans_dt
# MAGIC  
...
# MAGIC )
# MAGIC
# MAGIC SELECT trans_dt, src_scheme_id, src_cashpot_nm, dest_scheme_id, dest_cashpot_nm, 
# MAGIC cast(sum(val_trans) as float) * 0.01 as amt_transfered, 
# MAGIC count(wallet_id_dest) as num_transfers, 
# MAGIC count(distinct wallet_id_dest) as num_people
# MAGIC FROM transfers
# MAGIC WHERE trans_dt < current_date()
