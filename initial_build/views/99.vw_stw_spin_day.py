...
# MAGIC CREATE WIDGET TEXT view_name DEFAULT "vw_stw_spin_day";
...
# MAGIC AS
# MAGIC select
# MAGIC   cast(game_start_ts as date) as game_start_dt,
# MAGIC   count(*) as customer_count
# MAGIC from
# MAGIC   ${widget.core_catalog}.gb_mb_dl_tables.game_wallets
# MAGIC where
# MAGIC   rec_status_ind LIKE 'CURRENT'
# MAGIC   and cast(game_start_ts as date) < current_date()
# MAGIC GROUP BY
# MAGIC   cast(game_start_ts as date)
# MAGIC
