...
# MAGIC CREATE WIDGET TEXT view_name DEFAULT "vw_trading_sp_cmpgn_scanners_ghs";
...
# MAGIC                 and to_date(msn.cmpgn_cmplt_ts) >= '2022-08-01' -- full launch
...
# MAGIC                         where upper(chnl_nm) = 'ECOM' and to_date(event_ts) between '2022-11-01' and date_add(current_date(),-1)) as pos -- full launch
