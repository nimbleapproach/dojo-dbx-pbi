...
# MAGIC CREATE WIDGET TEXT view_name DEFAULT "vw_trading_sp_cmpgn_scanners_store";
...
# MAGIC                 ,'In-store Only' as chnl_nm
...
# MAGIC                 where upper(chnl_nm) = 'STORE' and to_date(event_ts) between '2022-11-01' and date_add(current_date(),-1)) as pos -- full launch
